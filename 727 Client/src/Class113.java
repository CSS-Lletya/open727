...
public class Class113 {
	...
	static final void method1883(int i) {
		for (Class282_Sub50_Sub16 class282_sub50_sub16 = ((Class282_Sub50_Sub16) client.aClass482_7333.method8097((byte) 68)); null != class282_sub50_sub16; class282_sub50_sub16 = ((Class282_Sub50_Sub16) client.aClass482_7333.method8067(380890791))) {
			...
			if (-1809259861 * client.anInt7174 > class521_sub1_sub1_sub3.anInt10392 * -780553027) {
				class282_sub50_sub16.method4991(-371378792);
				class521_sub1_sub1_sub3.method15906(220489197);
			} else if (-1809259861 * client.anInt7174 >= -362500645 * class521_sub1_sub1_sub3.anInt10393) {
				...
				if (1198158801 * class521_sub1_sub1_sub3.anInt10382 > 0) {
					if (4 == -891719545 * client.anInt7341) {
						Class521_Sub1_Sub1_Sub2 class521_sub1_sub1_sub2 = Class82.aClass75Array804[(class521_sub1_sub1_sub3.anInt10382 * 1198158801) - 1].method1342((byte) 22);
						if (null != class521_sub1_sub1_sub2) {
							...
							if ((int) class385.aFloat4671 >= 0 && ((int) class385.aFloat4671 < client.aClass257_7353.method4424(1637325924) * 512) && (int) class385.aFloat4673 >= 0 && ((int) class385.aFloat4673 < client.aClass257_7353.method4451(-601813258) * 512))
								class521_sub1_sub1_sub3.method15904((int) class385.aFloat4671, (int) class385.aFloat4673, ((Class504.method8389((int) class385.aFloat4671, (int) class385.aFloat4673, class521_sub1_sub1_sub2.aByte7967, (byte) 107)) - (class521_sub1_sub1_sub3.anInt10384 * -1502066599)), client.anInt7174 * -1809259861, -209443166);
						}
					} else {
						...
						if (class282_sub47 != null) {
							...
							if ((int) class385.aFloat4671 >= 0 && ((int) class385.aFloat4671 < client.aClass257_7353.method4424(-574006566) * 512) && (int) class385.aFloat4673 >= 0 && ((int) class385.aFloat4673 < client.aClass257_7353.method4451(-1609941818) * 512))
								class521_sub1_sub1_sub3.method15904((int) class385.aFloat4671, (int) class385.aFloat4673, ((Class504.method8389((int) class385.aFloat4671, (int) class385.aFloat4673, class521_sub1_sub1_sub3.aByte7967, (byte) 124)) - -1502066599 * (class521_sub1_sub1_sub3.anInt10384)), client.anInt7174 * -1809259861, -209443166);
						}
					}
				}
				if (1198158801 * class521_sub1_sub1_sub3.anInt10382 < 0) {
					int i_6_ = (-(1198158801 * class521_sub1_sub1_sub3.anInt10382) - 1);
					Class521_Sub1_Sub1_Sub2_Sub1 class521_sub1_sub1_sub2_sub1;
					if (client.anInt7315 * 1595512269 == i_6_)
						class521_sub1_sub1_sub2_sub1 = Class84.myPlayer;
					else
						class521_sub1_sub1_sub2_sub1 = (client.aClass521_Sub1_Sub1_Sub2_Sub1Array7314[i_6_]);
					if (null != class521_sub1_sub1_sub2_sub1) {
						...
						if ((int) class385.aFloat4671 >= 0 && ((int) class385.aFloat4671 < (client.aClass257_7353.method4424(1706889017) * 512)) && (int) class385.aFloat4673 >= 0 && ((int) class385.aFloat4673 < client.aClass257_7353.method4451(-1329029745) * 512))
							class521_sub1_sub1_sub3.method15904((int) class385.aFloat4671, (int) class385.aFloat4673, (Class504.method8389((int) (class385.aFloat4671), (int) (class385.aFloat4673), (class521_sub1_sub1_sub3.aByte7967), (byte) 88) - (class521_sub1_sub1_sub3.anInt10384 * -1502066599)), client.anInt7174 * -1809259861, -209443166);
					}
				}
