...
public class Class282_Sub23 extends Class282 {
	...
	static final void method12366(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
		if (1 == client.anInt7341 * -891719545) {
			int i_7_ = -963499271 * Class197.anInt2429;
			int[] is = Class197.anIntArray2433;
			for (int i_8_ = 0; i_8_ < i_7_; i_8_++) {
				Class521_Sub1_Sub1_Sub2_Sub1 class521_sub1_sub1_sub2_sub1 = client.aClass521_Sub1_Sub1_Sub2_Sub1Array7314[is[i_8_]];
			...
			for (int i_9_ = 0; i_9_ < -685729279 * client.anInt7211; i_9_++) {
				...
				if (null != class282_sub47)
					((Class521_Sub1_Sub1_Sub2) class282_sub47.anObject8068).method15818(i, i_0_, i_1_, i_2_, i_3_, i_4_, i_5_, 1391480104);
			}
		}
	}
}
