...
public class Class332 {
	static Class332 aClass332_3874;
	public static Class332 aClass332_3875 = new Class332(1);
	int anInt3876;

	Class332(int i) {
		((Class332) this).anInt3876 = i * 1958060475;
	}

	static {
		aClass332_3874 = new Class332(0);
	}

	static void method5927(int i, byte i_0_) {
		Class180.aClass229_2245.method3858(i, (byte) 12);
	}

	public static Class350 method5928(RsByteBuffer class282_sub35, int i) {
		Class350_Sub3 class350_sub3 = (Class350_Sub3) Class163.method2843(class282_sub35, 653185943);
		int i_1_ = class282_sub35.method13081(2118082241);
	...
	public static void method5930(int i, byte i_2_) {
