...
public class Class405 {
	...
	void method6814(RsByteBuffer class282_sub35, int i, int i_0_) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -20839), 1372393939);
		else if (3 == i) {
	...
	void method6817(RsByteBuffer class282_sub35, int i) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -16959), 310252785);
		else if (3 == i) {
			anInt4833 = class282_sub35.readUnsignedShort() * 1847456201;
			anInt4834 = class282_sub35.readUnsignedByte() * 1551601905;
			anInt4835 = class282_sub35.readUnsignedByte() * 1948460257;
	...
	void method6818(RsByteBuffer class282_sub35, int i) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -343), -522685697);
		else if (3 == i) {
			anInt4833 = class282_sub35.readUnsignedShort() * 1847456201;
			anInt4834 = class282_sub35.readUnsignedByte() * 1551601905;
			anInt4835 = class282_sub35.readUnsignedByte() * 1948460257;
	...
	void method6819(RsByteBuffer class282_sub35, int i) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -30059), -537574707);
		else if (3 == i) {
			anInt4833 = class282_sub35.readUnsignedShort() * 1847456201;
			anInt4834 = class282_sub35.readUnsignedByte() * 1551601905;
			anInt4835 = class282_sub35.readUnsignedByte() * 1948460257;
	...
	void method6820(RsByteBuffer class282_sub35, int i) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -22515), -1959371639);
		else if (3 == i) {
			anInt4833 = class282_sub35.readUnsignedShort() * 1847456201;
			anInt4834 = class282_sub35.readUnsignedByte() * 1551601905;
			anInt4835 = class282_sub35.readUnsignedByte() * 1948460257;
	...
	void method6821(RsByteBuffer class282_sub35, int i) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -29417), -116444694);
		else if (3 == i) {
			anInt4833 = class282_sub35.readUnsignedShort() * 1847456201;
			anInt4834 = class282_sub35.readUnsignedByte() * 1551601905;
			anInt4835 = class282_sub35.readUnsignedByte() * 1948460257;
	...
	void method6822(RsByteBuffer class282_sub35, int i) {
		if (i == 1)
			aChar4832 = Class11.method470(class282_sub35.method13236((short) -4801), -1575919734);
		else if (3 == i) {
			anInt4833 = class282_sub35.readUnsignedShort() * 1847456201;
			anInt4834 = class282_sub35.readUnsignedByte() * 1551601905;
			anInt4835 = class282_sub35.readUnsignedByte() * 1948460257;
