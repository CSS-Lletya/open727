...
@WeaponSpecialSignature(weapons = { ItemNames.RUNE_CLAW }, specAmount = 25)
public class RuneClaws implements WeaponSpecials {

	/**
	 *Increases attack with 10% more Attack and Strength, but a slower speed.
	 *
	 */
	@Override
