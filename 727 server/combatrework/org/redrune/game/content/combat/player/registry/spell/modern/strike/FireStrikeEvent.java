 ...
 * @since 8/7/2017
 */
public class FireStrikeEvent implements CombatSpellEvent {
	...
	public void cast(Player player, CombatSpellContext context) {
		...
		ProjectileManager.sendProjectile(ProjectileManager.createSpeedDefinedProjectile(player, context.getTarget(), 2729, 30, 26, 52, 0, 0));
