 ...
 * @since 8/7/2017
 */
public class WaterSurgeEvent implements CombatSpellEvent{
	...
	public void cast(Player player, CombatSpellContext context) {
		...
		ProjectileManager.sendProjectile(ProjectileManager.createSpeedDefinedProjectile(player, context.getTarget(), 2707, 30, 26, 52, 0, 0));
