 ...
 * @since 8/7/2017
 */
public class WaterWaveEvent implements CombatSpellEvent {
	...
	public void cast(Player player, CombatSpellContext context) {
		...
		ProjectileManager.sendProjectile(ProjectileManager.createSpeedDefinedProjectile(player, context.getTarget(), 2706, 30, 26, 52, 0, 0));
