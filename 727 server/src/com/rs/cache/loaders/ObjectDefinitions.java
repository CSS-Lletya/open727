...
public class ObjectDefinitions {
	...
	public static void main(String[] args) throws IOException {
		Cache.init();
		/*
		 * ObjectDefinitions defs = getObjectDefinitions(48072); System.out.println(defs.objectAnimation);
		 */
															...
															if (opcode != 62) {
																if (opcode != 64) {
																	if (opcode == 65)
																		...
																		if (opcode != 67) {
																			if (opcode == 69)
																				accessBlock = stream.readUnsignedByte();
																			else if (opcode != 70) {
																				if (opcode == 71)
																																...
																																if (opcode == 105)
																																	...
																																	options[opcode
																																			+ -150] = stream
																																					.readString();
																																	/*
																																	 * if ( ! loader . showOptions ) options [ opcode + - 150 ] = null ;
																																	 */
																																} else if (opcode != 160) {
																																	if (opcode == 162) {
																																		aByte3912 = (byte) 3;
