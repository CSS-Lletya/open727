...
//		} /*
//			 * else if(javaVersionBuild != 0 || javaVersionBuild2 < 31) { title = "Outdated Java Version"; suggestion = "Your java seems outdated: "+getVersion()+".<br>You should update your to 6.0.31.";
//			 *//*
//				 * }else if (hasApplet && ((availableProcessors <= (x64Arch ? 2 : 1)) || ram <= (x64Arch ? 1024 : 512) || cpuClockFrequency <= 1500)) { title = "Weak Specs"; suggestion = "Your computer seems to have weak specs. You'd better download desktop client for better perfomance."; }
//				 */
//		if (title != null) {
